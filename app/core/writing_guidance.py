...
# -*- coding: utf-8 -*-
"""
Writing Guidance Builder - Build writing guidance and checklists.
"""
...
GENRE_GUIDANCE_TEXT: dict[str, str] = {
    ...
    "livestream": "题材加权：强化外部反馈-主角反制-数据变化即时闭环。",
...
def normalize_genre_token(genre: str) -> str:
    genre_map = {
        "仙侠": "xianxia",
        "都市": "urban-power",
        "言情": "romance",
    ...
    return genre_map.get(genre.strip(), genre.lower().replace(" ", "-"))
...
def build_methodology_strategy_card(
    *,
    ...
    profile_key = normalize_genre_token(genre) or "general"
...
def build_guidance_items(
    *,
    ...
    normalized_genre = normalize_genre_token(genre)
